---
name: handover
description: End a chat with a short handover document, so the next chat starts fresh, cheap and with nothing lost. Use when the user says "handover", "hand over", "wrap up this chat", "prepare the next chat", "maak een overdracht", "draag over naar een nieuwe chat", or when a conversation has grown long and the user wants to continue the work in a new one.
---
